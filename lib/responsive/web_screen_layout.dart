...
import 'package:my_google/widgets/web/search_buttons.dart';
import 'package:my_google/widgets/web/web_footer.dart';
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
                icon: SvgPicture.asset('assets/more-apps.svg',
                    color: primaryColor),
                onPressed: () {}),
            const SizedBox(width: 10),
            Padding(
